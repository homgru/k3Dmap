...
**지도 표현 설정** 패널에서 지형·건물·농경지·숲 표현을 조절할 수 있습니다. 기본값은 `dist/cartography.json`에서 관리합니다. [설정 항목과 적용 방법](CONFIGURATION.md)을 참고하세요. 화면 변경은 현재 세션에만 적용되며, 내려받은 설정 파일을 교체·배포하면 기본값으로 재사용할 수 있습니다.
